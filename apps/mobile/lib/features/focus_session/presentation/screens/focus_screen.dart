...
import 'package:homeo/features/focus_session/presentation/providers/streak_recovery_providers.dart';
...
import 'package:homeo/features/focus_session/presentation/screens/streak_recovery_view.dart';
...
class FocusScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final streakBreak = ref.watch(streakBreakProvider);

    return switch (phase) {
      FocusPhase.idle =>
        streakBreak == null
            ? const FocusHomeView()
            : StreakRecoveryView(streakBreak: streakBreak),
