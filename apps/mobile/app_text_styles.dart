...
abstract final class AppTextStyles {
  ...
  static final TextStyle headline =
      _base.copyWith(fontSize: 26, fontWeight: FontWeight.w600, height: 1.3);
  ...
  static final TextStyle titleMedium =
      _base.copyWith(fontSize: 17, fontWeight: FontWeight.w600, height: 1.35);
  ...
  static final TextStyle labelLarge =
      _base.copyWith(fontSize: 15, fontWeight: FontWeight.w600, height: 1.3);
  static final TextStyle labelMedium =
      _base.copyWith(fontSize: 13, fontWeight: FontWeight.w600, height: 1.3);
